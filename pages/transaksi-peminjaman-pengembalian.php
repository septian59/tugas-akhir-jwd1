...
<div id="content">
    ...
    <!-- <p id="tombol-tambah-container"><a href="index.php?p=anggota-input" class="tombol">Transaksi Peminjaman</a> -->
    <a target="_blank" href="pages/dompdf.php"><img src="print.png" height="50px" height="50px"></a>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            ...
            if ($pencarian != "") {
                $sql = "SELECT * FROM tbtransaksi WHERE idtransaksi LIKE '%$pencarian%'
						...
						OR tglpinjam LIKE '%$pencarian%'OR tglkembali LIKE '%$pencarian%'";
    ...
    if (isset($_POST['pencarian'])) {
        ...
        <div class="pagination">
            ...
            for ($i = 1; $i <= $jml_hal; $i++) {
                if ($i != $hal) {
                    echo "<a href=\"?p=transaksi-peminjaman-pengembalian&hal=$i\">$i</a>";
                } else {
